...
export default function Footer({ setPage }) {
  ...
  return (
    <footer className="ytd-footer" style={{ marginTop: 100 }}>
      ...
      <div className="ytd-footer-legal" style={{ borderTop: `1px solid ${T.paper}22`, padding: "18px 24px", textAlign: "center", fontFamily: "'JetBrains Mono', monospace", fontSize: 11.5, color: `${T.paper}88` }}>
